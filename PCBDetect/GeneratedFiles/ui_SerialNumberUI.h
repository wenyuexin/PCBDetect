...
public:
    ...
    void setupUi(QWidget *SerialNumberUI)
    {
        ...
        lineEdit_roi_tl_x->setGeometry(QRect(1160, 160, 65, 35));
        QFont font;
        ...
        label->setGeometry(QRect(1080, 100, 181, 35));
        QFont font1;
        ...
        pushButton_getROI->setGeometry(QRect(1040, 270, 121, 40));
        pushButton_getROI->setFont(font2);
        line_2 = new QFrame(SerialNumberUI);
        line_2->setObjectName(QStringLiteral("line_2"));
        line_2->setGeometry(QRect(1000, 350, 341, 20));
        line_2->setFrameShape(QFrame::HLine);
        line_2->setFrameShadow(QFrame::Sunken);
        label_9 = new QLabel(SerialNumberUI);
        label_9->setObjectName(QStringLiteral("label_9"));
        label_9->setGeometry(QRect(1110, 400, 131, 35));
        ...
        lineEdit_serialNum->setGeometry(QRect(1010, 460, 241, 40));
        ...
        pushButton_recognize->setGeometry(QRect(1190, 270, 121, 40));
        ...
        pushButton_return->setGeometry(QRect(1120, 600, 121, 40));
        pushButton_return->setFont(font2);
        line_3 = new QFrame(SerialNumberUI);
        line_3->setObjectName(QStringLiteral("line_3"));
        line_3->setGeometry(QRect(1000, 550, 341, 20));
        ...
        pushButton_confirm->setGeometry(QRect(1260, 460, 81, 40));
